...
<head>
    ...
    <style>
        ...
        /* View Content Spacing - Core Sections (Original) */
        #view-calculator, #view-etiquetas, #view-rastreio {
            padding-top: 2rem !important;
        }

        /* View Content Spacing - Support Sections (Custom 60px) */
        #view-ajuda, #view-integracoes, #view-perfil {
        ...
        <main class="main-content">
            ...
            <div class="content-wrapper">
                ...
                <div id="view-etiquetas" style="display: none;">
                    ...
                    <div class="tabs">
                        <button class="tab active">Todas <span class="badge">0</span></button>
                        <button class="tab">A Emitir <span class="badge">0</span></button>
                        <button class="tab">A Postar <span class="badge">0</span></button>
                    </div>
...
8px;"></i>
    ...
    <script>
        ...
        function switchView(viewName, element) {
            ...
            const views = ['calculator', 'etiquetas', 'rastreio', 'ajuda', 'integracoes', 'perfil'];
            views.forEach(v => {
        ...
        function renderUserOrders(orders) {
            ...
            if (etiquetasListCount) etiquetasListCount.innerText = orders.length;
            if (rastreioCountAll) rastreioCountAll.innerText = orders.length;

            if (orders.length === 0) return;

            // Render Etiquetas View - If there are orders, replace empty state
            let etiquetasHtml = `<div class="orders-list-compact" style="display:flex; flex-direction:column; gap:12px;">`;
            orders.forEach(o => {
                const statusColor = o.status === 'confirmed' ? '#22c55e' : (o.status === 'pending' ? '#eab308' : '#ef4444');
                const statusText = o.status === 'confirmed' ? 'PAGO' : (o.status === 'pending' ? 'PENDENTE' : o.status.toUpperCase());
