...
if __name__ == "__main__":
    ...
    source_img = os.path.join(base_dir, "assets", "img", "Design-sem-nome-2.png")
    dest_img = os.path.join(base_dir, "assets", "img", "hero-image.webp")
    
    convert_to_webp(source_img, dest_img, quality=80)
